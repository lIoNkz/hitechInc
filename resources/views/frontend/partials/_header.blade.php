...
<embed src="/img/svg/line4.svg" class="svg_banner svg14"> 
  ...
  <div class="wrapp main-menu__wrapp">
    ...
    <div class="main-menu__inner">
      <form action="https://qaz-tech.kz/search" class="main-menu__search _hidden js-main-search">
    ...
    <div class="submenu__inner">
      <nav class="submenu__nav">
        <div class="submenu__item">
      	...
      	<div class="submenu__item">
          	<a href="/seo" class="submenu__link">SEO продвижение</a>
      	</div>
            ...
            <span>Сайт визитка</span>
					...
					<a href="/razrabotka-saitov/internet-magazin" class="m-submenu__link _sale">
						<span>Интернет-магазин</span>
							        						...
							        						<li class="m-submenu__item">
					<a href="/seo" class="m-submenu__link _sale">
						<span>SEO</span>
					</a>
				</li>
							        						<li class="m-submenu__item">
