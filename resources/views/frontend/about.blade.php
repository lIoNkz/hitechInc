...
<section class="mp-main">
  <h1 class="mp-main__title">Веб-студия HITECH</h1>
  <div class="mp-wrapp mp-main__wrapp">
    <div class="mp-timer">
      <div class="mp-timer__layout mp-timer__layout--text">
        <p>С <b>2015</b> года компания HI-TECH является первой в ЮКО ITкомпанией и digital-агентством полного цикла предоставляющие услуги, включающие в себя не только разработку, но и реализацию и оптимизацию рекламных кампаний; работу со всеми рекламными каналами (SMM, SEO, контекстная реклама, медийная реклама, и т.д.); а так же, продакшен – разработку креативных материалов, сайтов и мобильных приложений.</p>
<p>
Мы являемся сертифицированными партнерами наиболее распространенных рекламных платформ и сервисов: Yandex.Direct, Google.AdWords.
</p>
<p>
Для решения поставленных задач, над проектами наших клиентов работают только эксперты своего дела, за счет чего мы добиваемся успехов в сжатые сроки, делая бизнес наших клиентов более прибыльным! На данном этапе в компании работает 11 человек. 4 ITспециалиста под руководством опытного начальника закончивший Хельсинский университет высоких технологий с отличием, 4 менеджера по продажам, бухгалтер и директор.
</p>
<p>
Миссия компаний заключается в том, что мы нацелены создавать технологии, для лучшего будущего нашей страны.
Подробнее о <a href="/mission">миссии нашей компании.</a>
        </p>
      </div>
      <div class="mp-timer__layout">
        <p>Разработано сайтов</p>
        <div class="mp-timer__counter js-sites-counter"><ins>1</ins><ins>2</ins><ins>2</ins><ins>9</ins></div>
        <p>за 3 года</p>
      </div>
    </div>
    <ul class="mp-big-features">
      <li class="mp-big-features__item mp-big-features__item--since">
        <div class="mp-big-features__inner">
          <div class="mp-img mp-big-features__pic"><img src="/img/pic-bfeature1.png" alt=""></div>
          <div class="mp-big-features__text">
            <p class="mp-big-features__digits">3</p>
            <p class="mp-big-features__years-name">года</p>
          </div>
        </div>
        <p class="mp-big-features__note">
          Занимаемся разработкой сайтов с 2015 года
        </p>
      </li>
      <li class="mp-big-features__item mp-big-features__item--office">
        <div class="mp-big-features__inner">
          <div class="mp-img mp-big-features__pic"><img src="/img/pic-bfeature2.png" alt=""></div>
          <div class="mp-big-features__text">
            <p class="mp-big-features__digits">1</p>
            <p class="mp-big-features__offices-name">офис</p>
          </div>
        </div>
        <p class="mp-big-features__note">
      ...
      <li class="mp-big-features__item mp-big-features__item--staff">
        <div class="mp-big-features__inner">
          <div class="mp-img mp-big-features__pic"><img src="/img/pic-bfeature3.png" alt=""></div>
          <div class="mp-big-features__text">
            <p class="mp-big-features__staff-text">более</p>
            <p class="mp-big-features__digits">20</p>
            <p class="mp-big-features__staff-text">сотрудников</p>
          </div>
        </div>
        <p class="mp-big-features__note">
...
<section class="mp-services-content">
  <div class="mp-wrapp mp-services-content__wrapp">
    <div class="mp-h2 mp-services-content__title">Наши партнеры</div>
    <nav class="mp-services-content__list">
      <a href="https://onicon.ru/?roistat_visit=8953956" rel="nofollow" target="_blank" class="mp-services-content__item mp-img">
        <img src="/img/pic-onicon.png" alt="">
      </a>
      <a href="https://maliver.ru/?roistat_visit=8953956" rel="nofollow" target="_blank" class="mp-services-content__item mp-img">
        <img src="/img/pic-maliver.png" alt="">
      </a>
      <a href="https://rekmala.ru/?roistat_visit=8953956" rel="nofollow" target="_blank" class="mp-services-content__item mp-img">
        <img src="/img/pic-rekmala.png" alt="">
      </a>
      <a href="https://megacrm.ru/?roistat_visit=8953956" rel="nofollow" target="_blank" class="mp-services-content__item mp-img">
        <img src="/img/pic-crm.png" alt="">
      </a>
    </nav>
    <video class="mp-services-content__video" width="560" height="315" controls>
      <source src="http://qaz-tech.kz/video/qaztech.mp4" type="video/mp4">
    </video>
  </div>
</section>
<section class="mp-request">
  <div class="mp-wrapp mp-request__wrapp">
    <h2 class="mp-h2 mp-request__title">Закажите продающий сайт от web-студии HITECH</h2>
    <div class="mp-request__text">
      <p>
    ...
    <form class="mp-request__form js-form" data-form_id="107761241">
      <div class="mp-request__form-inner">
        <label class="mp-request__input cd-input cd-input--required js-required">
      ...
      <button class="cd-btn cd-btn--L mp-request__btn">Заказать звонок</button>
      <p class="mp-request__note">Оставляя заявку, вы принимаете <a href="https://megagroup.ru/privacy" target="_blank">политику конфиденциальности</a></p>
    </form>
  </div>
</section>
<section class="lp-feedback">
  <div class="mp-wrapp lp-feedback__wrapp" role="toolbar">
    <div class="lp-feedback__title">Отзывы</div>
    <ul class="lp-cslider js-feedback-slider slick-initialized slick-slider slick-dotted">
      <div aria-live="polite" class="slick-list draggable"><div class="slick-track" role="listbox" style="opacity: 1; width: 5280px; transform: translate3d(-1320px, 0px, 0px);"><li class="lp-cslider__slide slick-slide slick-cloned" data-slick-index="-2" aria-hidden="true" tabindex="-1" style="width: 660px;">
        <div class="lp-cslider__card">
          <p class="lp-cslider__title">Вадим Клемцов</p>
          <p class="lp-cslider__subtitle">Основатель Сети Ломбардов «Корона»</p>
          <p class="lp-cslider__link-wr">
            <a href="https://megagroup.ru/compani#" class="lp-cslider__link" tabindex="-1">korona-surgut.ru</a>
          </p>
          <div class="lp-cslider__content">
            <p>
              С «Мегагрупп» начали сотрудничать в 2009 году. Компания динамично развивается и предоставляет очень
              широкий
              спектр услуг и сервисов. Особая благодарность отделу контекстной рекламы. Все заказанные нами услуги
              выполнялись точно в срок и качественно. Все это подкрепляется сервисом на высоком уровне и вежливостью
              сотрудников. Спасибо Вам.
            </p>
          </div>
        </div>
      </li><li class="lp-cslider__slide slick-slide slick-cloned" data-slick-index="-1" aria-hidden="true" tabindex="-1" style="width: 660px;">
        <div class="lp-cslider__card">
          <p class="lp-cslider__title">Дмитрий Баширов</p>
          <p class="lp-cslider__subtitle">Генеральный директор ООО «Солид Профиль»</p>
          <p class="lp-cslider__link-wr">
            <a href="https://megagroup.ru/compani#" class="lp-cslider__link" tabindex="-1">cap.msk.ru</a>
          </p>
          <div class="lp-cslider__content">
            <p>
              Немного о нашей совместной работе: первый раз о Вашей компании узнал 3-3,5 года назад, когда возникла
              необходимость в создании сайта.
            </p>
            <p>
              Решающим фактором при выборе Вашей компании стал большой выбор готовых шаблонов сайтов и конечно же одна
              из самых низких цен. В дальнейшем очень понравились сервисы Onicon ( удобно отслеживать посетителей на
              сайте) и возможность быстро самостоятельно редактировать фото и описание.
            </p>
            <p>
              Ну и одно из самых важных плюсов нашей совместной работы, это контекстная реклама, примерно за 6 месяцев
              ведения рекламы Вашими специалистами отдача от рекламы в разы эффективнее чем самостоятельное продвижение.
            </p>
          </div>
        </div>
      </li><li class="lp-cslider__slide slick-slide slick-current slick-active" data-slick-index="0" aria-hidden="false" tabindex="-1" role="option" aria-describedby="slick-slide00" style="width: 660px;">
        <div class="lp-cslider__card">
          <p class="lp-cslider__title">Вадим Клемцов</p>
          <p class="lp-cslider__subtitle">Основатель Сети Ломбардов «Корона»</p>
          <p class="lp-cslider__link-wr">
            <a href="https://megagroup.ru/compani#" class="lp-cslider__link" tabindex="0">korona-surgut.ru</a>
          </p>
          <div class="lp-cslider__content">
            <p>
              С «Мегагрупп» начали сотрудничать в 2009 году. Компания динамично развивается и предоставляет очень
      ...
      </li><li class="lp-cslider__slide slick-slide slick-active" data-slick-index="1" aria-hidden="false" tabindex="-1" role="option" aria-describedby="slick-slide01" style="width: 660px;">
        <div class="lp-cslider__card">
          <p class="lp-cslider__title">Дмитрий Баширов</p>
          <p class="lp-cslider__subtitle">Генеральный директор ООО «Солид Профиль»</p>
          <p class="lp-cslider__link-wr">
            <a href="https://megagroup.ru/compani#" class="lp-cslider__link" tabindex="0">cap.msk.ru</a>
          </p>
          <div class="lp-cslider__content">
            <p>
              Немного о нашей совместной работе: первый раз о Вашей компании узнал 3-3,5 года назад, когда возникла
      ...
      </li><li class="lp-cslider__slide slick-slide" data-slick-index="2" aria-hidden="true" tabindex="-1" role="option" aria-describedby="slick-slide02" style="width: 660px;">
        <div class="lp-cslider__card">
          <p class="lp-cslider__title">Вадим Клемцов</p>
          <p class="lp-cslider__subtitle">Основатель Сети Ломбардов «Корона»</p>
          <p class="lp-cslider__link-wr">
      ...
      </li><li class="lp-cslider__slide slick-slide" data-slick-index="3" aria-hidden="true" tabindex="-1" role="option" aria-describedby="slick-slide03" style="width: 660px;">
        <div class="lp-cslider__card">
          <p class="lp-cslider__title">Дмитрий Баширов</p>
          <p class="lp-cslider__subtitle">Генеральный директор ООО «Солид Профиль»</p>
          <p class="lp-cslider__link-wr">
      ...
      </li><li class="lp-cslider__slide slick-slide slick-cloned" data-slick-index="4" aria-hidden="true" tabindex="-1" style="width: 660px;">
        <div class="lp-cslider__card">
          <p class="lp-cslider__title">Вадим Клемцов</p>
          <p class="lp-cslider__subtitle">Основатель Сети Ломбардов «Корона»</p>
          <p class="lp-cslider__link-wr">
      ...
      </li><li class="lp-cslider__slide slick-slide slick-cloned" data-slick-index="5" aria-hidden="true" tabindex="-1" style="width: 660px;">
        <div class="lp-cslider__card">
          <p class="lp-cslider__title">Дмитрий Баширов</p>
          <p class="lp-cslider__subtitle">Генеральный директор ООО «Солид Профиль»</p>
          <p class="lp-cslider__link-wr">
